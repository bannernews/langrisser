		...
		if (soldDat[i][10]==soldClas){
			...
			if (heroes[0]!=""){
				...
				for (j=0;j<heroes.length;j++){
					hreff = ('hero_mob.html?name='+ heroes[j]).replace(/ /g,"%20");
			...
			'.png" height="110px" /></div><div style="display:block;width:320px;float:left;"><b style="font-size: 18px;margin-right: 3px;vertical-align:super;">' + soldDat[i][0]+ 
			...
			'</span> <img onclick=iconHeroOpen("' + NA.replace(/ /g,"") + '") src="images/icon.png" height="20px" /></div><br><br><div><span style="font-size:18px;vertical-align:super;margin-right:3px;">ОЗ: ' + soldDat[i][2]  + 
			',</span><span style="font-size:18px;vertical-align:super;margin-right:3px;">ATK: ' + soldDat[i][3]  + 
			',</span><span style="font-size:18px;vertical-align:super;margin-right:3px;">ЗАЩ: ' + soldDat[i][4]  + 
			',</span><span style="font-size:18px;vertical-align:super;margin-right:3px;">МЗАЩ: ' + soldDat[i][5]  + 
			'</span></div><div style="white-space: normal;"><span style="font-size:16px;font-style:italic;">' + soldDat[i][8]  + 
