...
for (i=0;i<skins.length;i++){
	...
	chb0.innerHTML += '<div style="display:block;width:100%;height:520px;text-align:center;"><img id="heroimg" style="margin:0 auto;" src="images/heroes/heroes_list/'+ heroName +'/Card/'+skins[i]+'.png" /></div>';
}
