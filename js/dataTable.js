...
h_forge_pic.innerHTML = '<div id="forge_div" style="width:100%;display:block;text-align:center;position:relative;"><img id="forge_base" src="images/forge/forge_1.png" height="290px"/><br><span id="forge_icon">(Ковка / Путь Законов)<br>Нажмите на иконку чтоб узнать подробности</span></div>';
...
sold_text.innerHTML += '<img src="images/sold_stats.png" height="20px"><span style="vertical-align:super;margin-right:30px;">ОЗ: '+dataTable[hero_number][18]+'%</span><img src="images/sold_stats.png" height="20px"><span style="vertical-align:super;margin-right:30px;">АТК: '+dataTable[hero_number][19]+'%</span><img src="images/sold_stats.png" height="20px"><span style="vertical-align:super;margin-right:30px;">ЗАЩ: '+dataTable[hero_number][20]+'%</span><img src="images/sold_stats.png" height="20px"><span style="vertical-align:super;margin-right:30px;">МЗАЩ: '+dataTable[hero_number][21]+'%</span>';
...
if (chb.length==2){
	...
	uzi_l.innerHTML = '<span style="display:block;width:170px;height:auto;margin:0 auto;margin-top:25px;white-space:pre-wrap;margin-bottom:10px;">Разблокировка личных уз</span>';
	...
	uzi_dr.innerHTML = '<span style="display:block;width:170px;height:100%;margin:0 auto;margin-top:25px;white-space:pre-wrap;margin-bottom:16px;">Разблокировка других уз</span>';
	...
	h_info3.innerHTML = '<table border="0" style="width:100%;"><tr><td id="uzi_l1" rowspan="9" style="width:18%;background-image:url(images/uzi_l.png);background-repeat:no-repeat;background-size:contain;">Для личных уз</td><td id="chb1" style="height:20px;position:relative;" rowspan="6"></td><td style="font-size:20px;height:20px;">ОЗ</td><td style="width:27%;height:20px;"><span>'+classStats[chb[0]-1][3]+'</span></td><td id="uzi_dr1" rowspan="9" style="width:18%;background-image:url(images/uzi_dr.png);background-repeat:no-repeat;background-size:contain;white-space:pre-wrap;">Для чужих уз</td></tr><tr style="font-size:20px;"><td style="height:20px;">АТК</td><td style="height:20px;"><span>'+classStats[chb[0]-1][4]+'</span></td></tr><tr style="font-size:20px;"><td style="height:20px;">ИНТ</td><td style="height:20px;"><span>'+classStats[chb[0]-1][5]+'</span></td></tr><tr style="font-size:20px;"><td style="height:20px;">ЗАЩ</td><td style="height:20px;"><span>'+classStats[chb[0]-1][6]+'</span></td></tr><tr style="font-size:20px;"><td style="height:20px;">МЗАЩ</td><td style="height:20px;"><span>'+classStats[chb[0]-1][7]+'</span></td></tr><tr style="font-size:20px;"><td style="height:20px;">НАВЫК</td><td style="height:20px;"><span>'+classStats[chb[0]-1][8]+'</span></td></tr><tr><td colspan="3"><img src="images/shadow.png" width="100%" height="20px" /></td></tr><tr><td style="height:20px;font-size:20px;"><img src="images/Icon_Range.png" height="25px" /> '+classStats[chb[0]-1][9]+' <img src="images/'+classStats[chb[0]-1][11]+'.png" height="25px" /> '+classStats[chb[0]-1][10]+' </td><td style="height:50px;"><img src="images/heart.png" height="40px" /><br>4 уровень</td><td style="height:50px;white-space:break-spaces;vertical-align:middle;"><span>'+classStats[chb[0]-1][12]+'</span></td></tr><tr><td></td><td style="height:50px;"><img src="images/heart.png" height="40px" /><br>7 уровень</td><td style="height:50px;white-space:break-spaces;vertical-align:middle;"><span>'+classStats[chb[0]-1][13]+'</span></td></tr></table>';
	var chb1 = document.getElementById("chb1");
	var chibiskin = dataTable[hero_number][26].split(",");
	var chibi1skin = [];
	chibi1skin[0]='0'+classStats[chb[0]-1][14]+'.png';
	...
	uzi_dr1.innerHTML = '<span style="display:block;width:170px;height:100%;margin:0 auto;margin-top:10px;white-space:pre-wrap;">Разблокировка других уз</span><br>';
	if (dataTable[hero_number][30]!==''){
	...
	h_info3.innerHTML += '<table border="0" style="width:100%;"><tr><td id="uzi_dr3" rowspan="10" style="width:18%;background-image:url(images/uzi_l.png);background-repeat:no-repeat;white-space:pre-wrap;">Для других уз</td><td id="chb3" style="width:27%;height:20px;position:relative;" rowspan="6"></td><td style="font-size:20px;width:10%;height:20px;">ОЗ</td><td style="font-size:20px;width:27%;height:20px;"><span>'+classStats[chb[2]-1][3]+'</span></td></tr><tr style="font-size:20px;"><td style="height:20px;">АТК</td><td style="height:20px;"><span>'+classStats[chb[2]-1][4]+'</span></td></tr><tr style="font-size:20px;"><td style="height:20px;">ИНТ</td><td style="height:20px;"><span>'+classStats[chb[2]-1][5]+'</span></td></tr><tr style="font-size:20px;"><td style="height:20px;">ЗАЩ</td><td style="height:20px;"><span>'+classStats[chb[2]-1][6]+'</span></td></tr><tr style="font-size:20px;"><td style="height:20px;">МЗАЩ</td><td style="height:20px;"><span>'+classStats[chb[2]-1][7]+'</span></td></tr><tr style="font-size:20px;"><td style="height:20px;">НАВЫК</td><td style="height:20px;"><span>'+classStats[chb[2]-1][8]+'</span></td></tr><tr><td colspan="3"><img src="images/shadow.png" width="100%" height="20px" /></td></tr><tr><td style="height:20px;font-size:20px;"><img src="images/Icon_Range.png" height="25px" /> '+classStats[chb[2]-1][9]+' <img src="images/'+classStats[chb[2]-1][11]+'.png" height="25px" /> '+classStats[chb[2]-1][10]+'</td><td style="height:50px;"><img src="images/heart.png" height="40px" /><br>4 уровень</td><td style="height:50px;white-space:break-spaces;vertical-align:middle;"><span>'+classStats[chb[2]-1][12]+'</span></td></tr><tr><td></td><td style="height:50px;"><img src="images/heart.png" height="40px" /><br>7 уровень</td><td style="height:50px;white-space:break-spaces;vertical-align:middle;"><span>'+classStats[chb[2]-1][13]+'</span></td></tr><tr><td style="height:60px;" colspan="4"></td></tr></table>';
...
//	<img style="position:absolute;top:0;left:120px;" src="images/moon.png" height="190px" /><img style="position:absolute;top:0;left:120px;" src="images/heroes/heroes_list/'+ heroName +'/Chibi/'+classStats[chb[2]-1][14]+'.png" height="180px" /><img style="position:absolute;top:0;left:260px;" src="images/classes/'+classStats[chb[2]-1][2]+'.png" height="60px" />
	...
	uzi_dr3.innerHTML = '<span style="display:block;width:170px;height:100%;margin:0 auto;margin-top:10px;white-space:pre-wrap;">Разблокировка других уз</span><br>';
	if (dataTable[hero_number][30]!==''){
...
if (dataTable[hero_number][32]!==''){
	...
	for (i=0;i<pers00.length;i++){
		...
		cl00.innerHTML += '<div style="text-align:left;display:block;width:100%;height:auto;float:left;"><div style="position:relative;display:block;width:100px;height:100px;float:left;"><img style="position:absolute;top:2px;left:2px;" src="images/skills/personal/'+ persSkills[pers00[i]-1][1] +'.png" height="80px" /><img style="position:absolute;" src="images/Border_Icon_skill.png" height="84px" /><img style="position:absolute;top:73px;left:'+cc+';" src="images/'+persSkills[(pers00[i]-1)][2]+'c.png" height="16px" /></div><div style="display:block;width:70%;height:auto;float:left;"><b>'+persSkills[pers00[i]-1][1]+'</b><br><br><img src="images/sold_stats.png" height="20px"><span style="vertical-align:super;margin-right:30px;display:inline-block;width:156px;">'+skill_type[persSkills[pers00[i]-1][3]]+'</span><img src="images/sold_stats.png" height="20px"><span style="vertical-align:super;margin-right:30px;">Перезарядка: '+persSkills[pers00[i]-1][6]+'</span><br><img src="images/sold_stats.png" height="20px"><span style="vertical-align:super;margin-right:30px;display:inline-block;width:156px;">Дальность: '+persSkills[pers00[i]-1][4]+'</span><img src="images/sold_stats.png" height="20px"><span style="vertical-align:super;margin-right:30px;">Диапазон: '+persSkills[pers00[i]-1][5]+'</span></div></div><div style="text-align:left;display:block;width:97%;height:auto;float:left;white-space:pre-wrap;">'+persSkills[pers00[i]-1][7]+'</div><br>';
...
if (dataTable[hero_number][34]=='' && dataTable[hero_number][35]==''){
	if (heroName == 'Алканфель' || heroName == 'Макишима Агито' || heroName == 'Шо Фукамачи' || heroName == 'Мари Роуз' || heroName == 'Ниотэнгу' || heroName == 'Касуми' || heroName == 'Люси' || heroName == 'Эльза' || heroName == 'Нацу' || heroName == 'Райза' || heroName == 'Лила' || heroName == 'Клаудия' || heroName == 'Д-мен' || heroName == 'Синья' || heroName == 'Миюки'){
