...
var persItemDat = [
    ...
    [
        ...
        "48",
        "",
        "ОЗ +10%. При наличии минимум 3 доп. стата от таланта, наложенные [Кошмар] и [Демонический] невозможно снять. Когда в пределах 3 клеток есть вражеский демон или святой юнит, получает Иммунитет.",
...
function persItemView (itemType) {
	...
	for (i=1;i<persItemDat.length;i++){
		if (persItemDat[i][4]==itemType){
			...
			'.png" height="120px" /><a href="'+hreff+'"><img style="position:absolute;top:65px;right:-10px;" title="' + persItemDat[i][0] + '" src="images/head_circle/' + persItemDat[i][0] + '.png" height="70px"  /></a></div><div style="display:block;width:700px;float:left;margin-left:164px;"><b style="font-size: 23px;margin-right: 50px;float:left;">' + persItemDat[i][2]+ 			'</b>' +
...
//			'</span> <img src="images/icon.png" height="25px" />
			...
			'</div></div><br><br><div style="white-space: normal;margin-left:164px;">' + descr + persItemDat[i][11]  + 
			'</div></div>';
		}
	}
}
