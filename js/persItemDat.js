...
function persItemView (itemType) {
	...
	for (i=1;i<persItemDat.length;i++){
		if (persItemDat[i][4]==itemType){
			...
			'.png" height="120px" /><img style="position:absolute;top:65px;right:-10px;" title="' + persItemDat[i][0] + '" src="images/head_circle/' + persItemDat[i][0] + '.png" height="70px" /></div><div style="display:block;width:700px;float:left;margin-left:164px;"><b style="font-size: 23px;margin-right: 50px;float:left;">' + persItemDat[i][2]+ 			'</b>' +
