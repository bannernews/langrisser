...
var persItemDat = [
    ...
    [
        ...
        "",
        "",
        "ОЗ и ЗАЩ +5%. Когда сражается с врагом у которого есть [сопротивление смертельнмоу урону], АТК и ЗАЩ увеличиваются на 10%. После получения смертельного урона и срабатывании таланта, на клетке героя появится [осколок души]. (Перезарядка того эффекта 3 хода).",
