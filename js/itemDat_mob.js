...
function itemView (itemType) {
	...
	for (i=1;i<itemDat.length;i++){
		if (itemDat[i][2]==itemType){
			if (itemDat[i][3]!=''){var oz='<img src="images/sold_stats.png" height="23px" /><span style="font-size:20px;vertical-align:super;margin-right:2px;">ОЗ: ' + itemDat[i][3] + '</span>'}else{var oz=''};
			if (itemDat[i][4]!=''){var atk='<img src="images/sold_stats.png" height="23px" /><span style="font-size:20px;vertical-align:super;margin-right:2px;">АТК: ' + itemDat[i][4] + '</span>'}else{var atk=''};
			if (itemDat[i][5]!=''){var intt='<img src="images/sold_stats.png" height="23px" /><span style="font-size:20px;vertical-align:super;margin-right:2px;">ИНТ: ' + itemDat[i][5] + '</span>'}else{var intt=''};
			if (itemDat[i][6]!=''){var def='<img src="images/sold_stats.png" height="23px" /><span style="font-size:20px;vertical-align:super;margin-right:2px;">ЗАЩ: ' + itemDat[i][6] + '</span>'}else{var def=''};
			if (itemDat[i][7]!=''){var mdef='<img src="images/sold_stats.png" height="23px" /><span style="font-size:20px;vertical-align:super;margin-right:2px;">МЗАЩ: ' + itemDat[i][7] + '</span>'}else{var mdef=''};
			if (itemDat[i][8]!=''){var crit='<img src="images/sold_stats.png" height="23px" /><span style="font-size:20px;vertical-align:super;margin-right:2px;">НАВЫК: ' + itemDat[i][8] + '</span>'}else{var crit=''};
			...
			'.png" height="70px" /></div><div style="display:block;width:310px;float:left;"><b style="font-size: 20px;margin-right: 100%;float:left;">' + itemDat[i][0]+'</b><br>' +
