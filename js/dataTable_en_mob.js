...
langu.href = "hero_mob.html?name="+heroName;

pcswap = document.getElementById('pcswap');
pcswap.href = "hero_en.html?name="+heroName;

if (heroName == 'Метью'){
	document.location.href = "work_en_mob.html";
}
if (heroName == 'Яркий призыватель'){
	document.location.href = "ChrisLLR_en_mob.html";
}
...
for (i=0;i<skins.length;i++){
	...
	chb0.innerHTML += '<div style="display:block;width:100%;height:340px;text-align:center;position:relative;"><img id="heroimg" style="margin:0 auto;" src="images/heroes/heroes_list/'+ heroName +'/Card/'+skins[i]+'.jpg" /><img style="position:absolute;top:0px;left:112px;" src="images/skin_source/'+skins[i].charAt(0)+'.png"></div>';
}
...
talant.innerHTML = 'Talent: <b>'+dataTable[hero_number][6]+'</b><br>'+dataTable[hero_number][7];
...
h_forge_pic.innerHTML = '<div id="forge_div" style="width:100%;display:block;text-align:center;position:relative;"><img id="forge_base" src="images/forge/forge_1.png" height="290px"/><br><span id="forge_icon">(Forging / Path of Laws)<br>Click on the icon for details</span></div>';
...
sold_text.innerHTML += '<img src="images/sold_stats.png" height="20px"><span style="vertical-align:super;margin-right:35px;">HP: '+dataTable[hero_number][18]+'%</span><img src="images/sold_stats.png" height="20px"><span style="vertical-align:super;margin-right:10px;">ATK: '+dataTable[hero_number][19]+'%</span><br><img src="images/sold_stats.png" height="20px"><span style="vertical-align:super;margin-right:20px;">DEF: '+dataTable[hero_number][20]+'%</span><img src="images/sold_stats.png" height="20px"><span style="vertical-align:super;">MDEF: '+dataTable[hero_number][21]+'%</span>';
...
if (chb.length==2){
	...
	uzi_l.innerHTML = '<span style="display:block;width:170px;height:auto;margin:0 auto;margin-top:15px;white-space:pre-wrap;margin-bottom:10px;">Personal bonds</span>';
	var imgbonddef = new Image();
	imgbonddef.src = 'images/head_circle/'+dataTable[hero_number][28]+'.png';
	imgbonddef.onload = function(){
		uzi_l.innerHTML += '<span style="display:block;width:170px;height:140px;margin:0 auto;">DEF<br><a href="hero_en_mob.html?name='+(dataTable[hero_number][28]).replace(/ /g,"%20")+'"><img style="cursor:pointer;margin-top:5px;" src="images/head_circle/'+dataTable[hero_number][28]+'.png" height="105px" /></a></span>';
	};
	...
	imgbondatk.onload = function(){
		uzi_l.innerHTML += '<span style="display:block;width:170px;height:140px;margin:0 auto;margin-top:2px;">ATK<br><a href="hero_en_mob.html?name='+(dataTable[hero_number][29]).replace(/ /g,"%20")+'"><img style="cursor:pointer;margin-top:5px;" src="images/head_circle/'+dataTable[hero_number][29]+'.png" height="105px" /></a></span>';
	};
	...
	uzi_dr.innerHTML = '<span style="display:block;width:170px;height:100%;margin:0 auto;margin-top:15px;white-space:pre-wrap;margin-bottom:6px;">Other bonds</span>';
	if (dataTable[hero_number][30]!==''){
		uzi_dr.innerHTML += '<span style="display:block;width:205px;height:auto;margin:0 auto;white-space:pre-wrap;">DEF<br></span>';
		for (i=0;i<drdef.length;i++){
			uzi_dr.innerHTML += '<a href="hero_en_mob.html?name='+(drdef[i]).replace(/ /g,"%20")+'"><img style="cursor:pointer;margin-left:5px;" src="images/head_circle/'+drdef[i]+'.png" height="'+widthu+'" /></a>';
		}
	}
	uzi_dr.innerHTML += '<br>';
	if (dataTable[hero_number][31]!==''){
		uzi_dr.innerHTML += '<span style="display:block;width:205px;height:auto;margin:0 auto;white-space:pre-wrap;">ATK<br></span>';
		for (i=0;i<dratk.length;i++){
			uzi_dr.innerHTML += '<a href="hero_en_mob.html?name='+(dratk[i]).replace(/ /g,"%20")+'"><img style="cursor:pointer;margin-left:5px;" src="images/head_circle/'+dratk[i]+'.png" height="'+widthu+'" /></a>';
		}
	}
	
} else if (chb.length==1){
	h_info3.innerHTML = '<table border="0" style="width:100%;" cellspacing="2"><tr><td rowspan="5" id="chb1" style="width:170px;height:170px;position:relative;">Чибик1</td><td style="height:20px;width:120px;">HP</td><td style="height:20px;width:50px;">'+classStats[chb[0]-1][3]+'</td><td rowspan="6" style="width:100px;"></td></tr><tr><td style="height:20px;">ATK</td><td style="height:20px;">'+classStats[chb[0]-1][4]+'</td></tr><tr><td style="height:20px;">INT</td><td style="height:20px;">'+classStats[chb[0]-1][5]+'</td></tr><tr><td style="height:20px;">DEF</td><td style="height:20px;">'+classStats[chb[0]-1][6]+'</td></tr><tr><td style="height:20px;">MDEF</td><td style="height:20px;">'+classStats[chb[0]-1][7]+'</td></tr><tr><td style="height:20px;font-size:20px;"><img src="images/Icon_Range.png" height="25px" /> '+classStats[chb[0]-1][9]+' <img src="images/'+classStats[chb[0]-1][11]+'.png" height="25px" /> '+classStats[chb[0]-1][10]+' </td><td style="height:20px;">SKILL</td><td style="height:20px;">'+classStats[chb[0]-1][8]+'</td></tr><tr><td colspan="4"><img src="images/shadow.png" width="100%" height="20px" /></td></tr><tr><td><img src="images/heart.png" height="40px" /><br>4 level</td><td colspan="3" style="white-space:break-spaces;vertical-align:middle;"><span>'+classStats[chb[0]-1][12]+'</span></td></tr><tr><td><img src="images/heart.png" height="40px" /><br>7 level</td><td colspan="3" style="white-space:break-spaces;vertical-align:middle;"><span>'+classStats[chb[0]-1][13]+'</span></td></tr></table><table border="0" style="width:100%;margin-left:-5px;" cellspacing="2"><tr><td id="uzi_l1" style="width:205px;background-image:url(images/uzi_l.png);background-repeat:no-repeat;white-space:pre-wrap;background-size:103%;">Personal bonds</td><td id="uzi_dr1" style="width:205px;background-image:url(images/uzi_dr.png);background-repeat:no-repeat;white-space:pre-wrap;background-size:103%;">Other bonds</td></tr></table>';
	...
	h_info3.innerHTML = '<table border="0" style="width:425px;"><tr><td id="chb1" style="width:170px;height:170px;position:relative;"></td><td style="height:170px;"></td><td id="chb2" style="width:170px;height:170px;position:relative;"></td></tr><tr><td style="height:20px;font-size:20px;"><img src="images/Icon_Range.png" height="25px" /> '+classStats[chb[0]-1][9]+' <img src="images/'+classStats[chb[0]-1][11]+'.png" height="25px" /> '+classStats[chb[0]-1][10]+'</td><td style="height:20px;"></td><td id="ch2" style="height:20px;font-size:20px;"><img src="images/Icon_Range.png" height="25px" /> '+classStats[chb[1]-1][9]+' <img src="images/'+classStats[chb[1]-1][11]+'.png" height="25px" /> '+classStats[chb[1]-1][10]+'</td></tr><tr style="font-size:20px;"><td style="height:20px;"><span style="color:'+ozA+';">'+classStats[chb[0]-1][3]+'</span></td><td style="height:20px;">HP</td><td style="height:20px;"><span style="color:'+ozB+';">'+classStats[chb[1]-1][3]+'</span></td></tr><tr style="font-size:20px;"><td style="height:20px;"><span style="color:'+atkA+';">'+classStats[chb[0]-1][4]+'</span></td><td style="height:20px;">ATK</td><td style="height:20px;"><span style="color:'+atkB+';">'+classStats[chb[1]-1][4]+'</span></td></tr><tr style="font-size:20px;"><td style="height:20px;"><span style="color:'+intA+';">'+classStats[chb[0]-1][5]+'</span></td><td style="height:20px;">INT</td><td style="height:20px;"><span style="color:'+intB+';">'+classStats[chb[1]-1][5]+'</span></td></tr><tr style="font-size:20px;"><td style="height:20px;"><span style="color:'+defA+';">'+classStats[chb[0]-1][6]+'</span></td><td style="height:20px;">DEF</td><td style="height:20px;"><span style="color:'+defB+';">'+classStats[chb[1]-1][6]+'</span></td></tr><tr style="font-size:20px;"><td style="height:20px;"><span style="color:'+mdefA+';">'+classStats[chb[0]-1][7]+'</span></td><td style="height:20px;">MDEF</td><td style="height:20px;"><span style="color:'+mdefB+';">'+classStats[chb[1]-1][7]+'</span></td></tr><tr style="font-size:20px;"><td style="width:24%;height:20px;"><span style="color:'+skillA+';">'+classStats[chb[0]-1][8]+'</span></td><td style="width:4%;height:20px;">SKILL</td><td style="width:24%;height:20px;"><span style="color:'+skillB+';">'+classStats[chb[1]-1][8]+'</span></td></tr><tr><td colspan="3"><img src="images/shadow.png" width="100%" height="20px" /></td></tr><tr><td style="height:50px;white-space:pre-wrap;padding:0 10px;vertical-align:middle;"><span>'+classStats[chb[0]-1][12]+'</span></td><td style="height:50px;"><img src="images/heart.png" height="40px" /><br>4 level</td><td style="height:50px;white-space:pre-wrap;padding:0 10px;vertical-align:middle;"><span>'+classStats[chb[1]-1][12]+'</span></td></tr><tr><td style="height:50px;white-space:pre-wrap;padding:0 10px;vertical-align:middle;"><span>'+classStats[chb[0]-1][13]+'</span></td><td style="height:50px;"><img src="images/heart.png" height="40px" /><br>7 level</td><td style="height:50px;white-space:pre-wrap;padding:0 10px;vertical-align:middle;"><span>'+classStats[chb[1]-1][13]+'</span></td></tr></table><br>';
	...
	h_info3.innerHTML += '<table border="0" style="width:100%;"><tr><td id="chb3" style="width:170px;height:170pxpx;position:relative;" rowspan="5"></td><td style="font-size:20px;width:120px;height:20px;">ОЗ</td><td style="font-size:20px;width:50px;height:20px;">'+classStats[chb[2]-1][3]+'</td><td rowspan="6" style="width:100px;"></td></tr><tr style="font-size:20px;"><td style="height:20px;">ATK</td><td style="height:20px;">'+classStats[chb[2]-1][4]+'</td></tr><tr style="font-size:20px;"><td style="height:20px;">INT</td><td style="height:20px;">'+classStats[chb[2]-1][5]+'</td></tr><tr style="font-size:20px;"><td style="height:20px;">DEF</td><td style="height:20px;">'+classStats[chb[2]-1][6]+'</td></tr><tr style="font-size:20px;"><td style="height:20px;">MDEF</td><td style="height:20px;">'+classStats[chb[2]-1][7]+'</td></tr><tr><td style="height:20px;font-size:20px;"><img src="images/Icon_Range.png" height="25px" /> '+classStats[chb[2]-1][9]+' <img src="images/'+classStats[chb[2]-1][11]+'.png" height="25px" /> '+classStats[chb[2]-1][10]+' </td><td style="height:20px;">SKILL</td><td style="height:20px;">'+classStats[chb[2]-1][8]+'</td></tr><tr><td colspan="4"><img src="images/shadow.png" width="100%" height="20px" /></td></tr><tr><td><img src="images/heart.png" height="40px" /><br>4 level</td><td colspan="3" style="white-space:break-spaces;vertical-align:middle;"><span>'+classStats[chb[2]-1][12]+'</span></td></tr><tr><td><img src="images/heart.png" height="40px" /><br>7 level</td><td colspan="3" style="white-space:break-spaces;vertical-align:middle;"><span>'+classStats[chb[2]-1][13]+'</span></td></tr></table><table border="0" style="width:100%;margin-left:-5px;" cellspacing="2"><tr><td id="uzi_l3" style="width:205px;background-image:url(images/uzi_l.png);background-repeat:no-repeat;white-space:pre-wrap;background-size:103%;">Personal bonds</td><td id="uzi_dr3" style="width:205px;background-image:url(images/uzi_dr.png);background-repeat:no-repeat;white-space:pre-wrap;background-size:103%;">Other bonds</td></tr></table>';
...
//	<img style="position:absolute;top:0;left:120px;" src="images/moon.png" height="190px" /><img style="position:absolute;top:0;left:120px;" src="images/heroes/heroes_list/'+ heroName +'/Chibi/'+classStats[chb[2]-1][14]+'.png" height="180px" /><img style="position:absolute;top:0;left:260px;" src="images/classes/'+classStats[chb[2]-1][2]+'.png" height="60px" />
	...
	uzi_l3.innerHTML = '<span style="display:block;width:170px;height:auto;margin:0 auto;margin-top:15px;white-space:pre-wrap;margin-bottom:10px;">Personal bonds</span>';
	uzi_l3.innerHTML += '<span style="display:block;width:170px;height:140px;margin:0 auto;">DEF<br><a href="hero_en_mob.html?name='+(dataTable[hero_number][28]).replace(/ /g,"%20")+'"><img style="cursor:pointer;margin-top:5px;" src="images/head_circle/'+dataTable[hero_number][28]+'.png" height="105px" /></a></span>';
	uzi_l3.innerHTML += '<span style="display:block;width:170px;height:140px;margin:0 auto;margin-top:2px;">ATK<br><a href="hero_en_mob.html?name='+(dataTable[hero_number][29]).replace(/ /g,"%20")+'"><img style="cursor:pointer;margin-top:5px;" src="images/head_circle/'+dataTable[hero_number][29]+'.png" height="105px" /></a></span>';
	drdef = dataTable[hero_number][30].split(",")
	dratk = dataTable[hero_number][31].split(",")
	bond_dr_sum = drdef.length + dratk.length;
	if (bond_dr_sum>=6){widthu="55px";}else{widthu="75px";}
	uzi_dr3.innerHTML = '<span style="display:block;width:170px;height:100%;margin:0 auto;margin-top:15px;white-space:pre-wrap;margin-bottom:6px;">Other bonds</span>';
	if (dataTable[hero_number][30]!==''){
		uzi_dr3.innerHTML += '<span style="display:block;width:205px;height:auto;margin:0 auto;white-space:pre-wrap;">DEF<br></span>';
		for (i=0;i<drdef.length;i++){
			uzi_dr3.innerHTML += '<a href="hero_en_mob.html?name='+(drdef[i]).replace(/ /g,"%20")+'"><img style="cursor:pointer;margin-left:5px;" src="images/head_circle/'+drdef[i]+'.png" height="'+widthu+'" /></a>';
		}
	}
	uzi_dr3.innerHTML += '<br>';
	if (dataTable[hero_number][31]!==''){
		uzi_dr3.innerHTML += '<span style="display:block;width:205px;height:auto;margin:0 auto;white-space:pre-wrap;">ATK<br></span>';
		for (i=0;i<dratk.length;i++){
			uzi_dr3.innerHTML += '<a href="hero_en_mob.html?name='+(dratk[i]).replace(/ /g,"%20")+'"><img style="cursor:pointer;margin-left:5px;" style="margin:4px 4px;" src="images/head_circle/'+dratk[i]+'.png" height="'+widthu+'" /></a>';
		}
	}
}
...
if (dataTable[hero_number][46]!==''){
	...
	c3_text.innerHTML = '<b style="font-size:larger;">'+persSkills[(dataTable[hero_number][46]-1)][0]+'</b><br><br><img src="images/sold_stats.png" height="20px"><span style="font-size:14px;display:inline-block;width:140px;vertical-align:super;margin-right:10px;">'+skill_type[persSkills[(dataTable[hero_number][46]-1)][3]]+'</span><img src="images/sold_stats.png" height="20px"><span style="font-size:14px;vertical-align:super;">Cooldown: '+persSkills[(dataTable[hero_number][46]-1)][6]+'</span><br><img src="images/sold_stats.png" height="20px"><span style="font-size:14px;display:inline-block;width:140px;vertical-align:super;margin-right:10px;">Range: '+persSkills[(dataTable[hero_number][46]-1)][4]+'</span><img src="images/sold_stats.png" height="20px"><span style="font-size:14px;vertical-align:super;">Span: '+persSkills[(dataTable[hero_number][46]-1)][5]+'</span>';
...
if (dataTable[hero_number][32]!==''){
	...
	for (i=0;i<pers00.length;i++){
		...
		cl00.innerHTML += '<div class="display_none c00p" style="margin-top:15px;"><div style="text-align:left;width:415px;height:auto;float:left;"><div style="position:relative;display:block;width:19%;height:100px;float:left;"><img style="position:absolute;top:2px;left:2px;" src="images/skills/personal/'+ persSkills[pers00[i]-1][1] +'.png" height="80px" /><img style="position:absolute;" src="images/Border_Icon_skill.png" height="84px" /><img style="position:absolute;top:73px;left:'+cc+';" src="images/'+persSkills[(pers00[i]-1)][2]+'c.png" height="16px" /></div><div style="display:block;width:80%;height:auto;float:left;"><b>'+persSkills[pers00[i]-1][0]+'</b><br><br><img src="images/sold_stats.png" height="20px"><span style="vertical-align:super;margin-right:10px;display:inline-block;width:130px;font-size:14px;">'+skill_type[persSkills[pers00[i]-1][3]]+'</span><img src="images/sold_stats.png" height="20px"><span style="vertical-align:super;margin-right:10px;font-size:14px;">Cooldown: '+persSkills[pers00[i]-1][6]+'</span><br><img src="images/sold_stats.png" height="20px"><span style="vertical-align:super;margin-right:10px;display:inline-block;width:130px;font-size:14px;">Range: '+persSkills[pers00[i]-1][4]+'</span><img src="images/sold_stats.png" height="20px"><span style="vertical-align:super;margin-right:10px;font-size:14px;">Span: '+persSkills[pers00[i]-1][5]+'</span></div></div><div style="text-align:left;display:block;width:97%;height:auto;float:left;white-space:pre-wrap;">'+persSkills[pers00[i]-1][7]+'</div><br>'+dop00+'</div>';
		dop00='';
	}
}
...
var cSPa = document.getElementById("cSPa");
if (dataTable[hero_number][47]==''){
...
function iconSP_Open(){
	SPOpen = document.getElementById("cSPa");
	SP1 = document.getElementById("SP1");
	if (SPOpen){
		if (SPOpen.classList.contains('display_none')){
			SP1.style.filter = "drop-shadow(0 0 1px white)";
			SPOpen.className = SPOpen.className.replace("display_none", "display_table");
		} else if (SPOpen.classList.contains('display_table')){
			SP1.style.filter = "none";
			SPOpen.className = SPOpen.className.replace("display_table", "display_none");
		}
	}
}
...
//mozaik3.style.display="none";
	if (builds[hero_number][4]!==''){
		...
		var b_pvep = document.getElementById("b_pvep");
		...
		for (i=0;i<bweap.length;i++){
			b_weapon.innerHTML += '<span style="margin-left:5px;height:auto;display:block;width:74px;float:left;"><img src="images/itemIcons/all/'+bweap[i]+'.png" height="62px" /></span>';
		}
		for (i=0;i<bbody.length;i++){
			b_body.innerHTML += '<span style="margin-left:5px;height:auto;display:block;width:74px;float:left;"><img src="images/itemIcons/all/'+bbody[i]+'.png" height="62px" /></span>';
		}
		for (i=0;i<bhead.length;i++){
			b_head.innerHTML += '<span style="margin-left:5px;height:auto;display:block;width:74px;float:left;"><img src="images/itemIcons/all/'+bhead[i]+'.png" height="62px" /></span>';
		}
		for (i=0;i<bacc.length;i++){
			b_acc.innerHTML += '<span style="margin-left:5px;height:auto;display:block;width:74px;float:left;"><img src="images/itemIcons/all/'+bacc[i]+'.png" height="62px" /></span>';
		}
		for (i=0;i<bsold.length;i++){
			b_sold.innerHTML += '<span style="margin-left:3px;height:auto;display:block;width:90px;float:left;"><img src="images/soldIcons/all/'+bsold[i]+'.png" height="105px" /></span>';
		}
		for (i=0;i<bchari.length;i++){
			b_chari.innerHTML += '<span style="margin:5px;height:auto;display:block;width:62px;float:left;"><img src="images/chari/'+bchari[i]+'.png" height="62px" /></span>';
		}
...
//		mozaik3.style.display="none";
	...
	if (dataTable[hero_number][47]!==''){
		if (dataTable[hero_number][27].split(",").length!==2){
			...
			h_info5.innerHTML += '<table border="0" style="width:95%;margin:0 auto;"><tr><td style="width:9%;"><img src="images/item_type/weapon.png" height="62px" /></td><td id="b_weaponsp" style="width:90%;text-align:left;"></td></tr><tr><td><img src="images/item_type/body.png" height="62px" /></td><td id="b_bodysp" style="text-align:left;"></td></tr><tr><td><img src="images/item_type/head.png" height="62px" /></td><td id="b_headsp" style="text-align:left;"></td></tr><tr><td><img src="images/item_type/accessoir.png" height="62px" /></td><td id="b_accsp" style="text-align:left;"></td></tr><tr><td><img src="images/chant.png" height="62px" /></td><td id="b_charisp" style="vertical-align:top;"></td></tr><tr><td  id="b_soldsp" colspan="2" style="width:98%;"></td></tr><tr><td id="b_pvepsp" colspan="2" style="width:98%;"></td></tr></table>';
			...
			var b_pvepsp = document.getElementById("b_pvepsp");
			...
			for (i=0;i<bweapsp.length;i++){
				b_weaponsp.innerHTML += '<span style="margin-left:5px;height:auto;display:block;width:74px;float:left;"><img src="images/itemIcons/all/'+bweapsp[i]+'.png" height="62px" /></span>';
			}
			for (i=0;i<bbodysp.length;i++){
				b_bodysp.innerHTML += '<span style="margin-left:5px;height:auto;display:block;width:74px;float:left;"><img src="images/itemIcons/all/'+bbodysp[i]+'.png" height="62px" /></span>';
			}
			for (i=0;i<bheadsp.length;i++){
				b_headsp.innerHTML += '<span style="margin-left:5px;height:auto;display:block;width:74px;float:left;"><img src="images/itemIcons/all/'+bheadsp[i]+'.png" height="62px" /></span>';
			}
			for (i=0;i<baccsp.length;i++){
				b_accsp.innerHTML += '<span style="margin-left:5px;height:auto;display:block;width:74px;float:left;"><img src="images/itemIcons/all/'+baccsp[i]+'.png" height="62px" /></span>';
			}
			for (i=0;i<bsoldsp.length;i++){
				b_soldsp.innerHTML += '<span style="margin-left:3px;height:auto;display:block;width:90px;float:left;"><img src="images/soldIcons/all/'+bsoldsp[i]+'.png" height="105px" /></span>';
			}
			for (i=0;i<bcharisp.length;i++){
				b_charisp.innerHTML += '<span style="margin:5px;height:auto;display:block;width:62px;float:left;"><img src="images/chari/'+bcharisp[i]+'.png" height="62px" /></span>';
			}
