...
var persSkills = [
    ...
    [
        ...
        "3 клетки",
        "2",
        "[Призыв] Призывает принадлежащего вам единорога текущего класса в ближайшую позицию в пределах 3 клеток вокруг вас (единорог наследует характеристики снаряжения и 90% основных атрибутов Призывателя. При его наличии этот навык заменяется на [Возврат]).<br><br>Возврат<br>[Активный] Может высвободить 1 навык возврата. Время восстановления этого навыка наследует время восстановления используемого навыка:<br>[Возврат святого посланника] Телепортируется к единорога. Может переместиться еще на 2 клетки и снова атаковать. (После использования этого умения количество ходов баффов не будет уменьшено).<br>[Возврат единорога] Телепортирует единорога к себе."
    ],
    [
        "",
    ...
    [
        ...
        "все поле",
        "3",
        "[Пассивный] При вызове единорога или активном использовании этого умения у всех союзников «Легиона Сияния» на поле боя значительно улучшатся наступательные и защитные возможности, а урон, наносимый во время боя, будет увеличен на 15%. Вступая в бой, они будут восстанавливать ОЗ союзнику с наименьшим количеством ОЗ после битвы. Восстановленное количество ОЗ в два раза превышает интеллект заклинателя, длится 4 раунда. (Этот эффект нельзя комбинировать с другими навыками Энергии Слияния).<br><br><b>(Класс святой):</b> [Активный] Усильте сияющего единорога (если единорога не существует, он будет вызван первым), чтобы он мог получить [Сверкающую благодать и Милосердный дождь]: «В конце действия восстанавливает ОЗ дружественному отряду с наименьшим здоровьем в пределах 3 клеток вокруг один раз. Исцеление равняется 2x ИНТ заклинателя, рассеивает 1 дебафф и применяет 1 случайный сильный бафф, повторяется еще раз, когда у вас есть дебафф, повторяется еще раз, когда у вас более 5 баффов», длится 1 раунд и восстанавливает время перезарядки всех его навыков. После использования этот навык заменяется на [Благосклонность] (3С SR Крис с сохранением пассивной части), длится 3 раунда.<br><b>(Класс маг):</b> [Активный] Усиляет единорога Святого Грома, призванного вами (когда единорога не существует, он будет вызван первым), усилите следующее использование [Суд Священного Грома]: множитель навыка увеличивается в 1,5 раза; если цель на одной прямой, это умение игнорирует охрану. Когда враг не убит, Яркий Призыватель может действовать снова. Восстанавливает перезарадяку всех его навыков. После использования этот навык заменяется на [Благосклонность] (3С SR Крис с сохранением пассивной части), длится 3 раунда."
    ]
]
