...
var persSkills = [
    ...
    [
        ...
        "3 клетки",
        "2",
        "[Призыв] Призывает принадлежащего вам единорога текущего класса в ближайшую позицию в пределах 3 клеток вокруг вас (единорог наследует характеристики снаряжения и 90% основных атрибутов Призывателя. При его наличии этот навык заменяется на [Отзыв]).<br><br>Возврат<br>[Активный] Может высвободить 1 навык возврата. Время восстановления этого навыка наследует время восстановления используемого навыка:<br>[Святой отзыв] Телепортируется к единорогу. Может переместиться еще на 2 клетки и снова атаковать. (После использования этого умения количество ходов баффов не будет уменьшено).<br>[Отзыв единорога] Телепортирует единорога к себе."
    ],
    [
        "",
        "Священный вызов",
