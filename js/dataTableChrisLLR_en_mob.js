...
var dataTable = [
    ...
    [
        ...
        "20",
        "25",
        "Единорог,Эльф,Эльф-мастер,Экспедиция по природе,Ведьма,Колдунья,Фея-ворожея,Инквизитор,Монах,Епископ,Жрица,Экзорцист,Боевой монах,Солист ветроцвета,Команда спасения горы",
        "",
        "посох,молот",
        "тканевая",
        "0,2",
...
talant.innerHTML = '<span style="display:inline-block;margin-bottom:10px;font-size:15px;">Talent: <b>'+dataTable[hero_number][6]+'</b></span><br>'+dataTable[hero_number][7];
...
h_forge_pic.innerHTML = '<div id="forge_div" style="width:100%;display:block;text-align:center;position:relative;"><img id="forge_base" src="images/forge/forge_1.png" height="290px"/><br><span id="forge_icon">(Forge / Path of the Laws)<br>Click on the icon for details</span></div>';
...
if (chb.length==2){
	...
	imgbonddef.onload = function(){
		uzi_l.innerHTML += '<span style="display:block;width:170px;height:140px;margin:0 auto;">DEF<br><a href="hero_mob.html?name='+(dataTable[hero_number][28]).replace(/ /g,"%20")+'"><img style="cursor:pointer;margin-top:5px;" src="images/head_circle/'+dataTable[hero_number][28]+'.png" height="105px" /></a></span>';
	};
	...
	imgbondatk.onload = function(){
		uzi_l.innerHTML += '<span style="display:block;width:170px;height:140px;margin:0 auto;margin-top:2px;">ATK<br><a href="hero_mob.html?name='+(dataTable[hero_number][29]).replace(/ /g,"%20")+'"><img style="cursor:pointer;margin-top:5px;" src="images/head_circle/'+dataTable[hero_number][29]+'.png" height="105px" /></a></span>';
	};
