...
var dataTable = [
    ...
    [
        ...
        "20",
        "25",
        "Единорог,Эльф,Эльф-мастер,Экспедиция по природе,Ведьма,Колдунья,Фея-ворожея,Инквизитор,Монах,Епископ,Жрица,Экзорцист,Боевой монах,Солист ветроцвета,Горный отряд",
        "",
        "посох,молот",
        "тканевая",
        "0,2",
