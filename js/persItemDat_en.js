...
var persItemDat = [
    ...
    [
        ...
        "4",
        "",
        "МЗАЩ +10%. В случае уничтожения врага в этом ходу оглушает одного врага в радиусе 3 клеток после завершения действия на 1 ход.",
	...
	[
        ...
        "",
        "",
        "ОЗ и ЗАЩ +5%. Когда сражается с врагом у которого есть [сопротивление смертельнмоу урону], АТК и ЗАЩ войск увеличиваются на 10%. После получения смертельного урона и срабатывании таланта, на клетке героя появится [осколок души]. (Перезарядка этого эффекта 3 хода).",
