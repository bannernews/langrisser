...
imgFetter.onload = function(){
	...
	fetter_title.innerHTML += '<span style="line-height:2;display:block;width:120px;margin:0 auto;height:35px;">Confession  <img class="conf_hover" style="position:absolute;vertical-align:middle;cursor:pointer;" src="images/icon_confession.jpg" height="30px" onclick=window.open("'+confession[hero_number][1]+'","new_window"); /></span>';
};
