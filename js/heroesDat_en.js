...
//	sd.innerHTML = '<table><tr><th>Имя героя</th><th>Бонд для ОЗ,ЗАЩ</th><th>Бонд для АТК/ИНТ</th><th>Нужен для бондов другим героям</th></tr>';
	...
	for (i=1;i<heroesDat.length;i++){
		...
		sd.innerHTML += '<div class="' + f2 + ' ' + heroesDat[i][3] + ' ' + heroesDat[i][4] + ' ' + heroesDat[i][5] + ' ' + heroesDat[i][6] + '" style="display:block;height:135px;width:109px;float:left;"><div class="imgglow" style="display:block;"><img height="100px" src="images/head/' + heroesDat[i][0] + '.png" title="' + heroesDat[i][1] + '" onclick=location.href="'+hreff+'"></div><div style="white-space:normal;font-size:12px;width:95px;text-align:center;margin-top:-5px;">' + heroesDat[i][1] + '</div></div>';
//		}
	}
}
